...
const quantize_color = require('./quantize_color_filter');
...
function init(container) {
	...
	quantize_color.init(pixel_container);
}

module.exports = { init, palette, dither, contrast, grayscale, pixelate, quantize_color };
